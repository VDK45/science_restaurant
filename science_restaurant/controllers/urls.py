...
urlpatterns = [
    ...
    re_path(r'^archive/(?P<year>[0-9]{4})/', archive),  # http://127.0.0.1:8000/science_restaurant/archive/year/2022
    ...
    # http://127.0.0.1:8000/science_restaurant/test_get/a/?name=Garik&type=actor
    re_path(r'^month/(?P<month>[0-9])/', redirect_301),
